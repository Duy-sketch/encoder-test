...
#define GPIO_PIN_ENA GPIO_PIN_6
#define GPIO_IN3 GPIOA
#define GPIO_PIN_IN3 GPIO_PIN_4
#define GPIO_IN4 GPIOA
#define GPIO_PIN_IN4 GPIO_PIN_5
#define GPIO_ENB GPIOA
#define GPIO_PIN_ENA GPIO_PIN_6
...
void QuayThuan2() {
HAL_GPIO_WritePin(GPIO_IN3, GPIO_PIN_IN3, GPIO_PIN_SET);
HAL_GPIO_WritePin(GPIO_IN4, GPIO_PIN_IN4, GPIO_PIN_RESET);

}
void QuayNghich2() {
HAL_GPIO_WritePin(GPIO_IN3, GPIO_PIN_IN3, GPIO_PIN_RESET);
HAL_GPIO_WritePin(GPIO_IN4, GPIO_PIN_IN4, GPIO_PIN_SET);
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, INdongco2_Pin|INdongco2A5_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, INdongco1_Pin|INdongco1B4_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : INdongco2_Pin INdongco2A5_Pin */
  GPIO_InitStruct.Pin = INdongco2_Pin|INdongco2A5_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : INdongco1_Pin INdongco1B4_Pin */
  GPIO_InitStruct.Pin = INdongco1_Pin|INdongco1B4_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
